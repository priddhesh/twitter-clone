...
module.exports = {
  ...
  editUser: async (req, res) => {
    ...
    const avatar = req.files!=undefined? req.files.avatar!=undefined? req.files.avatar[0]: null:null
    const cover = req.files!=undefined? req.files.cover!=undefined? req.files.cover[0]: null:null;
